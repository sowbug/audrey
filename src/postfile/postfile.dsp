# Microsoft Developer Studio Project File - Name="postfile" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=postfile - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "postfile.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "postfile.mak" CFG="postfile - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "postfile - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "postfile - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "postfile - Win32 Debug"
...
# Name "postfile - Win32 Release"
# Name "postfile - Win32 Debug"
# Begin Source File
